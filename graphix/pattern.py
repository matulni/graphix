...
class Pattern:
    ...
    def to_unicode(
        ...
        >>> pattern = circuit.transpile().pattern
        >>> pattern.to_unicode()
        'X₂₄²¹ Z₂₄²⁰ X₃₂³¹ Z₃₂²⁸ X₃₀²⁹ Z₃₀⁰ ₂₇[M₃₁(0)]²⁸ E₃₁₋₃₂ N₃₂ [M₂₉(0)]⁰ E₂₉₋₃₀ N₃₀ ₂₆[M₂₈(3π/2)]²⁷ E₂₈₋₃₁ N₃₁ ₁₇[M₂₁(0)]²⁰ E₂₁₋₂₄ N₂₄ ₂₅[M₂₇(0)]²⁶ E₂₇₋₂₈ N₂₈ ₂₆₊₁₉₊₁₅₊₇[M₀(7π/4)] E₀₋₂₇ E₀₋₂₉ N₂₉ ₁₆[M₂₀(0)]¹⁷ E₂₀₋₂₁ N₂₁ ₂₃[M₂₆(0)]²⁵ E₂₆₋₂₇ N₂₇ ₂₂[M₂₅(0)]²³ E₂₅₋₂₆ N₂₆ ₁₅[M₁₇(7π/4)]¹⁶ E₁₇₋₂₀ N₂₀ ₁₉[M₂₃(π/4)]²² E₂₃₋₂₅...(63 more commands)'
        >>> pattern.to_unicode(left_to_right=True)
        'N₃ E₂₋₃ M₂(0) N₄ E₃₋₄ [M₃(0)]² E₄₋₁ N₅ E₄₋₅ ₂[M₄(0)]³ N₆ E₅₋₆ ₃[M₅(π/4)]⁴ N₇ E₆₋₇ ₄[M₆(0)]⁵ N₈ E₇₋₈ ₅[M₇(0)]⁶ E₈₋₀ N₉ E₈₋₉ ₆[M₈(0)]⁷ N₁₀ E₉₋₁₀ ₇[M₉(7π/4)]⁸ N₁₁ E₁₀₋₁₁ ₈[M₁₀(0)]⁹ N₁₂ E₁₁₋₁₂ ₉[M₁₁(0)]¹⁰ N₁₈ E₁₋₁₈ E₁₋₁₂ ₁₁₊₃[M₁(π/4)] N₁₃ E₁₂₋₁₃ ₁₀[M₁₂(0)]¹¹...(63 more commands)'
        >>> from graphix.command import CommandKind
        >>> pattern.to_unicode(target={CommandKind.M})
        '₂₇[M₃₁(0)]²⁸ [M₂₉(0)]⁰ ₂₆[M₂₈(3π/2)]²⁷ ₁₇[M₂₁(0)]²⁰ ₂₅[M₂₇(0)]²⁶ ₂₆₊₁₉₊₁₅₊₇[M₀(7π/4)] ₁₆[M₂₀(0)]¹⁷ ₂₃[M₂₆(0)]²⁵ ₂₂[M₂₅(0)]²³ ₁₅[M₁₇(7π/4)]¹⁶ ₁₉[M₂₃(π/4)]²² ₁₄[M₁₆(0)]¹⁵ ₁₃[M₁₅(0)]¹⁴ ₁₈[M₂₂(0)]¹⁹ ₁₂[M₁₄(0)]¹³ ₁[M₁₉(0)]¹⁸ ₁₁[M₁₃(π/4)]¹² [M₁₈(0)]¹ ₁₀[M₁₂(0)]¹¹ ₁₁₊₃[M₁(π/4)] ₉[M₁₁(0)]¹⁰ ₈[M₁₀(0)]⁹ ₇[M₉(7π/4)]⁸ ₆[M₈(0)]⁷ ₅[M₇(0)]⁶ ₄[M₆(0)]⁵ ₃[M₅(π/4)]⁴ ₂[M₄(0)]³ [M₃(0)]² M₂(0)'
